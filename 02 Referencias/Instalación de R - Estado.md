...
- **RStudio con R 4.6.1** ("Happy Hop"), plataforma `aarch64-apple-darwin23` — Mac con chip Apple Silicon.
- En la consola: `2 + 2` → `4`, y dos líneas adicionales imprimiendo el nombre de Carlos y el nombre del archivo de la entrega — el patrón típico de "prueba de vida" para demostrar que el entorno corre antes de entregar.
- Panel de archivos con el Home del sistema, sin proyecto de RStudio configurado todavía (no hay carpeta de proyecto visible en la captura).

## Qué implica para el vault
