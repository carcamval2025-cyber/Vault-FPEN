...
| 01–05, C1 | Sitio `docs/` con voz propia (tabloide económico): portada con gráfico y lupa, color por momento, cinta, índice y buscador Ctrl K | 2026-09-25 | `borrador` | [[2026-09-25 - Voz propia - tabloide económico]] | Dirección elegida por Carlos (prototipo A + color por momento); pendiente de revisión |
