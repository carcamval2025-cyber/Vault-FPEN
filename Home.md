...
Este vault se creó antes de que exista el primer material `.html` del curso. Todavía no hay una "sesión de referencia" — la primera que se construya (idealmente Semana 1) debe tratarse como el estándar de calidad, tal como indica el documento maestro del Proyecto. Cuando eso ocurra, actualiza esta sección y la de [[Registro de Materiales]].
